...
check_kinematics( phi3,phi4,phi5,phi6,phi7,phi8,phi9,phi10, ...
    ...
    diffphi3  = (phi3(3:size(phi3)) - phi3(1:size(phi3)-2)) / (2*Ts); % 2 posities terug
    ...
    subplot(334)
        ...
        ylabel('d\phi_{10} approximation [rad]')
        xlabel('t [s]')
    subplot(335)
        plot(t,dphi10)
        ylabel('d\phi_{10} exact [rad]')
        xlabel('t [s]')
    subplot(336)
