...
for k=1:t_size
    ...
    [x, fval, exitflag]=fsolve('loop_closure_eqs',[phi3_init phi4_init phi5_init phi6_init phi7_init phi8_init phi9_init phi10_init]',optim_options,phi2(k),r11, r12, r13,r2,r3,r4,r5,r6,r7,r8,r9a, r9b,r10a, r10b, phi11, phi12, phi13);
    if (exitflag ~= 1)
