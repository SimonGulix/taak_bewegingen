...
F(3) = r8*cos(phi8) + r7*cos(phi7) + r6*cos(phi6) + r10b*cos(phi10) + r2*cos(phi2) - r13*cos(phi13);
F(4) = r8*sin(phi8) + r7*sin(phi8) + r6*sin(phi6) + r10b*sin(phi10) + r2*sin(phi2) - r13*sin(phi13);
